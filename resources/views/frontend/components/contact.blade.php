        ...
        <div class="container text-center">
          <div class="row justify-content-center">
            <div class="col-12 col-lg-10 col-xl-8">
              ...
              <span class="text-muted">Get Response</span>
              <h2 class="display-4 fw-bold mt-2 mb-3">Send me your E-mail</h2>
              <p class="lead text-muted mb-5">I will response you as soon as possible</p>
              <form action="#">
                <div class="row justify-content-center">
                <div class="col-12 col-md-8 col-lg-5 mb-3 mb-lg-0">
                  ...
                  <div class="col-12 col-md-8 col-lg-2">
                    <button class="btn btn-primary w-100">Send Us</button>
                  </div>
                </div>
              </form>
            </div>
